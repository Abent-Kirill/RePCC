...
{
    public async Task<int> Handle(SaveToDatabaseRequest request, CancellationToken cancellationToken) => await ComputersRepository.AddAsync(request.ComputerRecord, cancellationToken);
}
